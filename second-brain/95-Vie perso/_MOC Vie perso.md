...
- [[Opération fiscalité propre (France → Dubaï)]] : TRC, liquidation SAS, radiation micro, fermeture des comptes FR — tout à Dubaï au 31/12. **État au 07/09** : micro radiée ✅, amendes SAS remises (250 + 1 200 €) ✅, attestation de régularité fiscale ✅ — reste URSSAF 3957, comptes de clôture, LegalPlace, radiation.
...
- [[Architecture bancaire Profit First (comptes, coffres, crypto, compta)]] : la synthèse de 3 agents (20/07, crypto-patrimoine retiré) — les **3 comptes** (Wio Business firewall + FAB perso hub + IBKR patrimoine, Wio Perso retiré), le **waterfall** et ses 3 garde-fous, la **décision 0 % crypto** (le BTC n'est pas un diversifieur + terrain d'impulsivité), le rail Binance corporate pour la paie chatteurs (fini le hop par le perso), le **salaire depuis Wio Business Payroll (SIF/WPS) → FAB** et la réalité crédit immo self-employed, la conversion €→USDT/AED optimisée, la compta/CT (SBR 0 % en 2026), et la checklist avant départ.

---
titre: "Sprint été - croissance sans moi"
type: plan
...
- **Lundi 14 — le jour Emma + rituels** : prise de sang à jeun · conversation Emma 1 h (périmètre, règle 1-3-1, ce qu'elle ne décide pas seule — [[Méthode de délégation - Emma (kit de passation)]], **fiches imprimables prêtes : [[Kit Emma - mode d'emploi]]**) · annonce de la grille aux équipes · appel de groupe test n°1. **+ TRC : déposer le dossier EmaraTax** (45 min, checklist dans [[Opération fiscalité propre (France → Dubaï)]]) et **radier la micro-entreprise** (10 min).

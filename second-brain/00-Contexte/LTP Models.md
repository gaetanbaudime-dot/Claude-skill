...
> | **Sarah** | **8 500 / 3 000 / 2,8** | (Lila Doré vient de lancer) | **Conversion** (a le trafic, pas la monétisation) | ⛔ **non** → c'est le chat (Maxence) |
...
>
> **La faute à ne pas commettre** : envoyer des clippers sur Sarah/Amanda parce qu'« elles sont grosses ». Plus de subs à 2 €/2,8 € de LTV ne fait quasi pas d'argent — c'est gâcher la ressource rare sur un goulot que les clippers ne touchent pas. **Sarah et Amanda sont des chantiers chat, pas des chantiers trafic.** Cette matrice **complète** (ne remplace pas) l'ordre de montée créatrices du roster ci-dessous : le roster dit *dans quelles créatrices investir*, cette matrice dit *où va la main-d'œuvre clipping*. Les 4 créatrices à zéro rappellent le vrai plafond : **le trafic (clippers) est le goulot n°1 de l'agence** ([[Théorie des contraintes]]).

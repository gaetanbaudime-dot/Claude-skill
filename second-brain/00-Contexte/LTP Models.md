...
statut: verified
créé: 2026-07-06
tags: [contexte/business, ofm/agence]
---

# LTP Models (agence OFM)

> [!info] Hub business
> L'entreprise principale de Gaëtan, distillée de l'export claude.ai (mémoire + projets + conversations). Noms de tiers aliasés : créatrices par nom de scène, équipe par prénom. Chiffres = derniers connus à l'export (juillet 2026), à rafraîchir en session.
...
Agence OFM francophone basée à Dubaï (**LTP International FZ-LLC**, free zone RAKEZ ; les contrats créatrices/clippers sont de droit français, mais le **[[Pacte d'association LTP (partenariat 50-50 avec Maxence)|pacte d'association]] est de droit UAE, arbitrage DIFC/ADGM** — ne pas confondre les deux familles de contrats). Co-fondée avec **Maxence** (sa propre entité free zone) : Gaëtan possède le pôle marketing/trafic/recrutement, Maxence le pôle chatting/monétisation (**~40 chatteurs + ~5 managers** à la commission, Madagascar/Bénin). Split de profit 50/50 **formalisé par le pacte signé le 26/03/2026**, calculé le 1er du mois selon la **[[SOP clôture mensuelle avec Maxence]]** (3 couches : P&L → allocations → distribution ; l'ancien calcul WhatsApp capitalisait 0 €). **« Asymétrie de coûts » à réconcilier** : le vault la notait (Gaëtan porterait l'essentiel des coûts clippers/VA sur split égal) — or le pacte (Art 5-6) classe clippers/VA/ads/chatters en **coûts communs déduits AVANT le 50/50** : sur le papier, pas d'asymétrie. Le vrai point d'attention est la **clause Key Person (Art 10.2)** au regard du départ en France ([[Pacte d'association LTP (partenariat 50-50 avec Maxence)|détail et parade dans le pacte]]). [[Journal de coaching|Journalisé]]. ⚠️ Chantier fiscal 2026 : la SAS française est dissoute depuis le 16/11/2025, **attestation de régularité fiscale obtenue le 07/09/2026** (amendes 250 + 1 200 € remises), reste la clôture de liquidation + radiation avant le 31/12 ; des flux MYM arrivaient encore sur des comptes perso FR → [[Opération fiscalité propre (France → Dubaï)]].
...
> [!tip] Snapshot monétisation 30 jours (chiffres dictés par Gaëtan, ~19/07) — le diagnostic à DEUX goulots
> **CA ~45 000 €/mois** (MYM ~25 330 € · OF ~21 620 $ ≈ 19 900 €), soit un rebond vs le creux du 13/07. Mais le chiffre agrégé cache la seule question qui compte pour allouer les clippers : **chaque créatrice est-elle bloquée par le TRAFIC (peu de subs) ou par la CONVERSION (beaucoup de subs, peu d'€/sub) ?** — parce que **les clippers ne réparent QUE le trafic.** Et ce clivage épouse *exactement* la répartition des pôles du [[Pacte d'association LTP (partenariat 50-50 avec Maxence)|pacte]] (Art 4) : trafic = **ton** mandat (clippers), conversion = **celui de Maxence** (chat).
>
> | Créatrice | MYM 30 j (€ / subs / LTV) | OF 30 j ($ / subs / LTV) | Goulot | Clippers ? |
> |---|---|---|---|---|
> | **Maddy** | 8 000 / 640 / **12,5** | pas d'OF | **Trafic** (monétise bien, plafonnée par le volume) | ✅ **priorité 1** + convaincre l'OF (upside latent max) |
> | **Chloé** | 6 800 / 540 / **12,5** (gratuit) | 8 250 / 1 010 / 8,2 | **Trafic** (LTV forte, page gratuite = machine à volume) | ✅ priorité 2 (clippers FR) |
> | **Jade** | 1 200 / 121 / 10,0 | 1 900 / 200 / 9,5 | **Trafic** (base énorme mais NEW subs en chute → ré-accélérer) | ✅ priorité 4 |
...
### La clôture de juin (le 1er P&L réel complet, calcul du 01/07 avec Maxence)
...
**Structure de commission (précisée de vive voix le 18/07)** : la part agence **varie par créatrice** — Chloé 40 %, Sophie 50 % (fourchette roster 40-50 %) ; − ~15 % de charges chatting → **marge ~25-35 % du CA géré selon la créatrice**. Conséquence de méthode : toute économie unitaire (clippers, ads, SFS) se calcule avec la marge de LA créatrice trackée, jamais avec une moyenne d'agence.
...
L'agence opère dans le périmètre du cluster [[_MOC OFM|OFM]] : chaque décision se relit contre [[Risques légaux et éthiques de l'OFM]] (Gaëtan a explicitement demandé que Claude signale les violations de CGU). Les cadres de travail sont [[Théorie des contraintes]], [[Rétention et LTV]] (la LTV avant le trafic), [[Core Four]] et [[Grand Slam Offer]] (offre coaching OFM Blueprint, 2 997€, garanties incluses).

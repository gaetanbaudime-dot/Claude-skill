...
3. **Scaling SFS** : 6-15x plus de revenu par clic qu'Instagram (conversion 47-68%), volume quasi nul → 1-2 SFS/semaine/créatrice, Rianah en prospection.
   - **Trafic interne MYM** (canal gratuit) : deal juillet avec Judith (AMB) = target **20 000 €** → 2 slots carousel août, condition = Chloé/Jade MYM ne baissent pas vs juin. Rapport KPI : goulots = *external traffic* (~6%) et *profile attraction* (~8%), pendant que *ability to convert* (~23%) et *chatting* (~39%) sont excellents. Modèle et exécution : [[Stratégie trafic interne MYM]] + [[Playbook trafic interne MYM (5 créatrices)]].

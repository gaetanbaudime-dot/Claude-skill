...
- [[Continuité du bot et paie sacrée (plan anti-panne)]] : le fondamental n°7 — les 6 verrous développés en procédures avant le départ (heartbeat/dead-man's switch — **pas un ping HTTP, le bot n'a pas d'URL** ; sauvegarde téléchargée hors Discord et restaurée en réel ; page « si le bot est mort » prête à remettre à Emma/Maxence ; Maxence payeur de secours via le **Sheet de consolidation**, pas via le bot ; rythme J+7/J+8 sans exception ; gel des déploiements via Watch Paths Railway) + le plan anti-Goodhart écrit avant le premier fraudeur.

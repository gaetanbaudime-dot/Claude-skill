---
titre: "Recrutement clippers - annonces et formulaire"
type: sop
cluster: "96-Opérations LTP"
statut: verified
créé: 2026-07-11
tags: [ops/recrutement, ops/annonces, ops/sourcing]
liens_forts: ["[[Équipe marketing - structure et rémunération (FR × MG)]]", "[[Entretien clipper - questions et grille de notation]]", "[[Machine Instagram-Facebook en masse]]", "[[Sourcing de candidats]]"]
---

# Recrutement clippers : annonces + formulaire (à jour rému 2026-07-11)
...
## Rappel rému (pour que toutes les annonces restent cohérentes)

- **FR** : fixe de démarrage **200 €/mois** (versé chaque semaine le 1er mois) + **0,50 €/sub OF vérifié**, déplafonné. Preuve : Julien 400-600 €/mois en 1 mois ; meilleurs ~1000 €+. Évolution → responsable acquisition (team leader).
- **MG / Bénin** : fixe de démarrage **100 €/mois** + **0,50 €/sub OF vérifié**, payé en euros (Wise). Même commission (équité au mérite), fixe au marché local.
- **Circuit** : FR → formulaire + **entretien vidéo** ([[Entretien clipper - questions et grille de notation]]) + semaine test payée. MG/Bénin → **formulaire + vocal de formation** (pas d'entretien, l'assiduité au vocal est le filtre).
...
## Le formulaire restructuré (Google Forms)

Objectif : **filtrer en 3 min** et **router FR vs MG/Bénin**. Pour les MG/Bénin, c'est le SEUL filtre → il doit être discriminant. Ordre pensé pour que les sérieux montrent leur sérieux et que les autres décrochent.

**Section 1 — Intro** (le pitch honnête, déjà bon dans ton actuel : 200-600 €/mois, contenu fourni, 100 % SFW à poster, 18+, niche créateurs).

**Section 2 — Identité & logistique**
1. Prénom
...
13. **Es-tu OK avec le modèle : fixe de démarrage + commission sur chaque abonné que tu ramènes sur OnlyFans ?** *(Oui / J'ai des questions / Non)* — remplace l'ancien « payé au sub » pur
14. Pourquoi veux-tu rejoindre l'agence ?
15. **Es-tu à l'aise avec la niche (contenu créatrices OnlyFans, 100 % SFW à poster) ?** *(Oui / Non)* — filtre discrétion, cohérent avec Q5 de l'[[Entretien clipper - questions et grille de notation|entretien]]
16. As-tu bien lu toute l'annonce ? *(Oui, en entier / En diagonale)* — le classique qui piège les non-lecteurs
17. Sur quel réseau as-tu vu l'annonce ? *(+ « parrainé par qui ? » → alimente le [[Équipe marketing - structure et rémunération (FR × MG)|parrainage]])*

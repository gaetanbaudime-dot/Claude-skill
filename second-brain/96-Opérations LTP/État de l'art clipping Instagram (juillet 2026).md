...
> [!info] Prolongement (2026-08-09)
> L'[[Étude - Distribution OFM, état de l'art (août 2026)]] élargit ce rapport à tous les canaux (Facebook Reels, Reddit, X, ads adult), à l'économie du compte de rotation (~8-15 €/compte, point mort 15-45 clics) et à la conversion post-clic (comment-to-DM = ×10). Ce rapport-ci reste la référence tactique Instagram pure. Le versant juridique (assurance de l'âge par IA de Meta, AI Act, procédure DSA « conception addictive ») est suivi dans la [[Veille réglementaire Meta (contrôles 2026-2027)]].

# Alex Hormozi : Map of Content

Cluster consacré à la doctrine Hormozi : qui il est, ses trois cadres majeurs, et sa philosophie d'exécution. Ce cluster est volontairement court et dense : Hormozi est un synthétiseur, et ses cadres sont les versions opérationnelles des piliers du cluster [[_MOC Marketing|Marketing]].

## Pages

- [[Alex Hormozi]] : parcours (Gym Launch, Acquisition.com), doctrine en 5 points, et les précautions de lecture (biais du survivant, personnage-marque).
- [[Grand Slam Offer]] : l'offre incomparable, dérisquée, à prix de valeur. Exécution de [[L'offre et la valeur perçue]].
- [[Équation de valeur]] : les 4 leviers de la valeur perçue, outil d'audit universel.
...
- **[[Les 20 actions Hormozi de Gaëtan]]** (2026-07-13) : la distillation des 5 grandes vidéos (levier, focus, mieux avant nouveau, talent, standards) en 20 actions calibrées sur les chiffres réels — dont 9 déjà installées dans le système, et les 5 flags où Hormozi se discute (sommeil, marshmallow, « balance »).
...
Marketing (exécution directe), [[Unit economics]] et [[Rétention et LTV]] (la LTV comme arme), [[Systèmes et process]] et [[Effet de levier]] (le passage du volume personnel au levier), [[Biais du survivant]] et [[Sophisme des coûts irrécupérables]] (les garde-fous de lecture).

## Rapport actionnable

`98-Rapports/Rapport Alex Hormozi` : séquence de décisions selon ton stade, grille d'audit d'offre, plan 100 jours.

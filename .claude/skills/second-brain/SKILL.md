...
2. **Ne juge jamais un actif sur un seul canal NI sur la mauvaise fenêtre temporelle.** Une créatrice faible en LTV MYM peut être n°1 sur OF ; et une « n°1 annuelle » peut être en déclin de -53 % sur 30 jours (double erreur Amanda, corrigée deux fois en 24 h, journalisée). L'agence réelle a quelques mois : **la fenêtre 30-60 jours prime sur l'année glissante** pour toute décision d'allocation. Croise canaux × fenêtres avant de trancher.

...
6. **Après le test validé** : équipe **France** (France/Belgique/Suisse) → tu envoies ton e-mail en message privé, le bot t'envoie ton contrat (signature électronique, 2 min, date de naissance + attestation majeur dans le document car 18 ans minimum obligatoire). **Dès que tu signes, tes accès s'ouvrent tout seuls (quelques minutes) : rôle Team France, ton espace privé et ton lien de tracking — tu n'attends personne, il n'y a pas de contre-signature à attendre.** Équipe **internationale** (autres pays) → **PAS de contrat à signer, pas de SIRET, pas de TVA**, et une date à retenir : **la grille internationale ouvre le 1er octobre 2026**. D'ici là ton dossier (candidature, quiz) est conservé et tu seras recontacté en priorité au lancement ; en attendant, reste sur le serveur et fais des bumps dans #bump. Dans les deux cas ensuite : le dossier de ta créatrice (rushs et modèles) est en lecture directe dans son salon grâce à ton rôle, puis Fiche 1 (comptes), warm-up, reporting du dimanche. Si après ~15 min (France) tu n'as rien reçu, vérifie que tes MP serveur sont ouverts, sinon renvoie ton numéro de téléphone en MP au bot.
...
**Je suis International : c'est quand le lancement ? (info officielle)** **La grille internationale ouvre le 1er octobre 2026.** D'ici là : pas de test, pas de contrat, pas d'attribution de créatrice — et ce n'est pas un oubli, c'est la date officielle. Ton dossier est conservé (candidature ET score de quiz : rien à repasser) et tu seras recontacté en priorité au lancement. En attendant, deux choses utiles : reste sur le serveur, et fais des **bumps** dans #bump (`/bump`, classement avec `!bumps`) — ça aide l'équipe et ça se voit. Inutile d'écrire dans #assistant-ia pour demander où en est ton dossier : la réponse est « le 1er octobre », pour tout le monde pareil.
...
**Le bot me relance trop / je reçois des rappels tous les jours ?** Réponds simplement **STOP** en message privé au bot : toutes les relances automatiques s'arrêtent, ton dossier reste ouvert, et tu reprends quand tu veux en renvoyant ton numéro. Les candidats internationaux en attente du 1er octobre ne reçoivent plus de rappels du tout — si tu en reçois encore, c'est corrigé, signale-le dans #assistant-ia.

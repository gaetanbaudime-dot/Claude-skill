...
**Combien de comptes je gère au total ?** Le setup complet par créatrice : **3 comptes Instagram (2 de croissance + 1 privé) + 3 pages Facebook.** Ni plus ni moins au départ — les extensions (comptes en plus) viennent après, avec les résultats (Fiche 5). Cadence de croisière (vers J+24) : **6 Reels/jour PAR compte de croissance**, soit 12/jour, republiés sur les pages Facebook. La montée est progressive : semaine 1 = 1 Reel/jour/compte, semaine 2 = 2, semaine 3 = 3, semaine 4 = on tient et on monte.

...
6. **Après le test validé** : équipe **France** (France/Belgique/Suisse) → tu envoies ton e-mail en message privé, le bot t'envoie ton contrat (signature électronique, 2 min, date de naissance + attestation majeur dans le document car 18 ans minimum obligatoire). **Dès que tu signes, tes accès s'ouvrent tout seuls (quelques minutes) : rôle Team France, ton espace privé et ton lien de tracking — tu n'attends personne, il n'y a pas de contre-signature à attendre.** Équipe **internationale** (autres pays) → ton rôle Team International s'ouvre directement et le bot t'envoie ton onboarding en message privé. Dans les deux cas : le dossier de ta créatrice (rushs et modèles) est en lecture directe dans son salon grâce à ton rôle, puis Fiche 1 (comptes), warm-up, reporting du dimanche. Si après ~15 min tu n'as rien reçu, vérifie que tes MP serveur sont ouverts, sinon renvoie ton numéro de téléphone en MP au bot.

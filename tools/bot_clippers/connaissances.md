...
**Ça prend combien de temps par jour, honnêtement ?** Au démarrage (1 Reel/jour/compte) : **~1 h par jour**. En croisière (12 Reels + publication échelonnée + stories + commentaires + reporting) : **2 à 4 h par jour**. Le montage prend ~15-30 min par Reel au début et accélère beaucoup avec l'habitude et les templates (dupliquer un montage qui marche = quelques minutes). Personne ne fait 12 Reels en 1 h — organise ta journée en 2 blocs (montage le matin, publication/interactions étalées).
